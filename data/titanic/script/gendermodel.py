...
csv_file_object = csv.reader(open('/Users/smrmkt/Documents/workspace/R/kaggle/data/titanic/csv/train.csv', 'rb')) #Load in the csv file
...
#1st Read in test
test_file_obect = csv.reader(open('/Users/smrmkt/Documents/workspace/R/kaggle/data/titanic/csv/test.csv', 'rb'))
header = test_file_obect.next()

#Now also open the a new file so we can write to it call it something
#descriptive

open_file_object = csv.writer(open("/Users/smrmkt/Documents/workspace/R/kaggle/data/titanic/csv/genderbasedmodelpy.csv", "wb"))
