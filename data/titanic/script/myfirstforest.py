...
csv_file_object = csv.reader(open('/Users/smrmkt/Documents/workspace/R/kaggle/data/titanic/csv/train.csv', 'rb')) #Load in the training csv file
...
test_file_object = csv.reader(open('/Users/smrmkt/Documents/workspace/R/kaggle/data/titanic/csv/test.csv', 'rb')) #Load in the test csv file
...
open_file_object = csv.writer(open("/Users/smrmkt/Documents/workspace/R/kaggle/data/titanic/csv/myfirstforest.csv", "wb"))
test_file_object = csv.reader(open('/Users/smrmkt/Documents/workspace/R/kaggle/data/titanic/csv/test.csv', 'rb')) #Load in the csv file
