...
# データの読み込み
train <- read.table('~/Documents/workspace/R/kaggle/data/titanic/csv/train.csv', header=T, sep=',')
test <- read.table('~/Documents/workspace/R/kaggle/data/titanic/csv/train.csv', header=T, sep=',')
